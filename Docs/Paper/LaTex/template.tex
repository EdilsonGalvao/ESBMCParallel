...
\begin{document}
\title{Applying Multi-Core Model Checking and Maximum Satisfiability to Hardware-Software Partitioning}
...
ESBMC implement four approaches: ESBMC, ESBMC-SS, ESBMC-PS, ESBMC-PB, and ESBMC-$\nu$Z.
