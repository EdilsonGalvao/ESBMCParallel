...
\textcolor{blue}{There is also the effort to create a hardware-software (HW/SW) co-simulation environment in order to help designers obtain an appropriate HW/SW partitioning that satisfy specified tradeoffs, as described by~\cite{Jan2005} and by~\cite{Hau2009}.}
...
\textcolor{blue}{Boucheneb, H. and Hadjidj, R. (2006) 'Using inclusion abstraction to construct Atomic State Class Graphs for Time Petri Nets', {\it Int. J. of Embedded Systems}, Vol. 2, N. 1/2, pp.128--139.}
...
\textcolor{blue}{Hau, Y.W. and Khalil-Hani, M. (2009) 'SystemC-based HW/SW co-simulation platform for system-on-chip (SoC) design space exploration', {\it Int. J. of Information and Communication Technology}, 2009, Vol.2, N. 1/2, pp.108--119.}
...
\textcolor{blue}{Jan, K. Y., Fan, C. B., Kuo, A. C., Yen, W. C., and Lin, Y. L. (2005) 'A platform based SOC design methodology and its application in image compression', {\it Int. J. of Embedded Systems}, Vol.1, N. 1/2, pp. 23--32.}
...
\textcolor{blue}{Mittal, S., and Vetter, J. (2015) 'A Survey of CPU-GPU Heterogeneous Computing Techniques', {\it ACM Computing Surveys}, Vol. 47, Issue 4, pp. 69:1--69:35.}
