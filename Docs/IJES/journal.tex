...
In the ESBMC algorithm is not necessary to add slack variables, because the modulus operation is kept, which reduces the number of variables to be solved. 
...
\bibitem[\protect\citeauthoryear{Trindade \textit{et al.}}{2016}]{Trindade2016}
...
Holzmann, G. (2012) 'Parallelizing the spin model checker', {\it Proc. of the Intl. Symp. on Model Checking Software}, Vol. 7385, pp.155--171
